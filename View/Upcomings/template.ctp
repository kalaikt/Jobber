...
?>
			<div class="container">
				<h3>Introduction to Cloud Computing With AWS</h3>
       		            <div><span style="font-size: 16px; "><br /><strong>Date:</strong> Tuesday, April 5th, <strong><br />Start:</strong> 7pm, <strong><br />Duration: </strong> 1 hour, <strong><br />Location: </strong>Live, Virtual </span></div>       
                    <div class="col-md-6 listedtext col-xs-12">
     		     	<ul>
     		     		...
     		     		<li>Understanding Amazon Computing Resources</li>
     		     		<li>Lauching the First Compute Node</li>
     		     		<li>Accessing the Compute Node</li>
     		     		<li>Saving Your Work for Future Use</li>
     		     ...
     		     <!-- div class="col-xs-12 tutorialtext">
     		     	<span>Audience</span>
     		     	<p>This live online course is the first introduction to cloud computing. You are not required to have any prior knowledge of cloud computing before attending this class. It will cover setting up account, lauching an EC2 instance and logging into the EC2 instance.</p>
     		     </div -->
				 <h3>Price: $19.95 </h3>
