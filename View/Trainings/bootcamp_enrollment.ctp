			...
			<div class="container">
					<table>
						...
						<tr>
							<td>1.</td>
							<td>BT301</td>
							<td>Convenient Boot Camp Program</td>
							<td>$399.00</td>
						</tr>
						<tr>
							<td>2.</td>
							<td>BT302</td>
							<td>Instructor Led Boot Camp Program</td>
							<td>$2498.00</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
					...
					<div class="col-md-4 enrollbtn col-xs-12"><!-- <a href="javascript:void(0);" class="btnarea" onclick="$('#item_name_1').val('Convenient - Fundamental &amp; Proficiency in Linux');$('#amount_1').val('<?php echo $convenient;?>'); $('#custom').val('<?php echo $userid, '|', 'Convenient - Fundamental &amp; Proficiency in Linux', '|', $convenient; ?>');">FLEXIBLE PROGRAM ($399)</a> --></div>
					<div class="col-md-4 ortext col-xs-12"> <!-- <div class="line"></div>or<div class="line"></div> --></div>
					<div class="col-md-4 enrollbtn col-xs-12"><a href="javascript:void(0);" class="btnarea" onclick="$('#item_name_1').val('Convenient Boot Camp ');$('#amount_1').val('<?php echo $convenient;?>'); $('#custom').val('<?php echo $userid, '|', 'Convenient Boot Camp', '|', $convenient; ?>');">BT301 ($399)</a></div>
					</div>
